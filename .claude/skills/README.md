...
Bu klasördeki beceriler depo ile birlikte sürümleniyor. Depo açıkken
kendiliğinden yükleniyorlar.

## Her projede kullanmak

Bir beceri yalnızca burada dururken bu depoya bağlı kalıyor. Kullanıcı
dizinine kopyalanınca makinedeki bütün projelerde geçerli oluyor:

```bash
cp -r .claude/skills/android-expressive-ui ~/.claude/skills/
```

Kopya bağımsız: depodaki güncellenirse aynı komutu tekrarlamak gerekiyor.
Tersi de doğru — kullanıcı dizinindeki değiştirilirse buradaki eskimiş
kalıyor, o yüzden asıl nüsha burası sayılmalı.

## android-expressive-ui
